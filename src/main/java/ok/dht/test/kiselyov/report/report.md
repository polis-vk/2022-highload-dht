...
составляет примерно 0.83s. 90% запросов выполняются за 1.12s в среднем, а 99% - за 15.04s. При скорости обработки
...
составляет примерно 2.11s. 90% запросов выполняются за 5.82s в среднем, а 99% - за 6.39s. При скорости обработки
