...
## PUT
### Latency(wrk2)
Ордеррейт 800 оказался стабилоной нагрузкой, при которой 99 процентов запросов укладывается в 19 мс, при нагрузке 1000
...
Можно заметить, что 65% RockDB.put на добавление данных, такой большой процент связан со сложностью данной операции и большим объемом данных в бд.
...
248 - 1000 мс, а 99 совсем ужас - 935. Что связано с большой загрузкой базы данных (20 гигов для моего компа жесть так то)
```
