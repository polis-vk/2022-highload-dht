...
Так же как и на предыдущем этапе GET и PUT не сильно отличаются.
...
Также в лекции упомянули, что для Completeble Future необходимо контролировать на каком пуле будет исполняться задачи, т.к если использовать 
