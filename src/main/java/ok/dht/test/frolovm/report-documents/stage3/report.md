...
растет несколько быстрее, чем с ним, а у нас реализация с шардированием
работает в ~1.4 раза медленнее, что является хорошим результатом. Из-за использования шардирования у нас будет в
