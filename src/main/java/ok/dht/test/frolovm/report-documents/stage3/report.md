     541.695     0.999939      1248656     16384.00
     542.207     0.999945      1248670     18204.44
     542.207     0.999951      1248670     20480.00
     543.231     0.999957      1248677     23405.71
     544.767     0.999963      1248682     27306.67
     545.791     0.999969      1248691     32768.00
     546.303     0.999973      1248694     36408.89
     546.815     0.999976      1248700     40960.00
     547.327     0.999979      1248703     46811.43
     547.839     0.999982      1248706     54613.33
     548.351     0.999985      1248711     65536.00
     548.351     0.999986      1248711     72817.78
     548.863     0.999988      1248715     81920.00
     548.863     0.999989      1248715     93622.86
     549.375     0.999991      1248719    109226.67
     549.375     0.999992      1248719    131072.00
     549.375     0.999993      1248719    145635.56
     549.887     0.999994      1248721    163840.00
     549.887     0.999995      1248721    187245.71
     550.399     0.999995      1248724    218453.33
     550.399     0.999996      1248724    262144.00
     550.399     0.999997      1248724    291271.11
     550.399     0.999997      1248724    327680.00
     550.399     0.999997      1248724    374491.43
     550.911     0.999998      1248727    436906.67
     550.911     1.000000      1248727          inf
#[Mean    =       39.591, StdDeviation   =       77.337]
#[Max     =      550.400, Total count    =      1248727]
#[Buckets =           27, SubBuckets     =         2048]
----------------------------------------------------------
  1499408 requests in 1.00m, 95.65MB read
Requests/sec:  24990.06
Transfer/sec:      1.59MB
```
...
Однако остальные ноды продолжали корректно работать. 
Заметим, что большое кол-во lock около 42% стало уходить на SequantialScheduler, это связано с тем, что 1/3 запросов
пытается достучаться до ноды которую мы выключили и не получает ответа.
...
Заметим, что использование Java HTTP client привело к дополнительному оверхэду.
Как мы можем заметить около 5% затратили на ожидание ответа от других нод. А также около 8% на отправку запроса 
другим нодам. Предположу, что HTTP тратит слишком много ресурсов отправку и получение requests, а мы при
реализации шардирования в несколько раз увеличили количество пересылаемых requests и responses.

Randevous Hashing занимает ~1% от общего CPU, основное время тратится на ChooseShard, которая как писалось выше 
ассимптотически хуже, чем вариант с консистентным хэшированием, но так как кол-во кластеров небольшое, то оно работает 
даже лучше.

### ALLOC

Заметим, что у нас на 9% выросла аллокация памяти для селекторов, что связано опять же с увеличением нагрузки на сеть.
Для alloc мы тратим около 15% на конкатенацию строк в RandevousHashing, 
что можно исправить выбрав другие параметры для хэширования ноды.

### Lock

Заметим, что Lock на HTTP session send response вырос c 5% до 35%, что опять же можно объяснить 
увеличением нагрузки на сеть. А также ожиданием ответа на запрос со стороны главной ноды, через которую мы 
направляем запросы на остальные.
...
Есть возможность оптимизировать выделение памяти при хэшировании ключа, так более 20% аллокаций выделяется
на создание строки shard + key. 
Также необходимо использовать хорошую хэш функцию (в данной реализации MURMUR3), 
для того чтобы алгоритм давал равномерное распределение по кластерам(как с примером с String.hashCode()).

Видим, что в итоге получилось хорошее распределение по кластерам. Что позволяет нам более равномерно распределить нагрузку,

Решение работает медленнее, что 
объясняется дополнительными затратами на пересылку 2/3 запросов в соседние кластера и так как мы делаем запросы через
одну ноду производительность конечно же падает, огромный процент работы CPU уходит на отправку HTTP Client.


Однако видно, что даже в такой "тестовой" ситуации нам удается добится 
некоторого параллелизма, как например в примере с PUT запросами Latency упала не в 1.6 раза, а в 1.4. 

Также был реализован алгоритм Circuit breaker, который позволяет переживать временные сбои, 
таких как медленные сетевые подключения, длительное время ожидания, перегруженные или временно недоступные ресурсы.
И в тот момент когда нода перестает болеть продолжать работу с данной нодой.
